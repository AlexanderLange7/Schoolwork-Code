...
//Implementing SimpleSLL.h to use our list
/**
 * Mose of the code in this cpp file will be used to code out all of our longer
 * methods for our singly linked list.
 * 
 * Alex, Alex
 * 9/06/2017
 */

//Delete Memory upon List Destruction
SimpleSLL::~SimpleSLL ()
{
  clear ();
}
...
//GetRandom Method is coded here
std::string SimpleSLL::getRandom() const
{
  return get(rand()%n);
}